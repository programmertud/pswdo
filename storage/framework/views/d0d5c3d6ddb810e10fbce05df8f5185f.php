...
<div class="shell">
    ...
    <aside class="sidebar">
        <div class="sidebar-brand">
            <img src="<?php echo e(asset('logo-hri.png')); ?>" alt="CSWDO Logo" class="logo-img">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('add.index')); ?>" class="nav-item <?php echo e(request()->routeIs('add.index') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('children.index')); ?>" class="nav-item <?php echo e(request()->routeIs('children.*') ? 'active' : ''); ?>">
        ...
        <div class="sidebar-footer">
            <div class="user-row">
                <div class="user-avatar"><?php echo e(strtoupper(substr(session('username', 'A'), 0, 1))); ?></div>
                <div class="user-info">
                    <p><?php echo e(ucfirst(session('username', 'Admin'))); ?></p>
