...
<?php $__env->startSection('page-sub', 'CNSP, CAR & CICL Cases by LGU — <?php echo e(date("Y")); ?>'); ?>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="action-cell" style="text-align:center;">
                        <button class="btn-edit" onclick="openEditModal(<?php echo e($r->id); ?>, '<?php echo e(addslashes($r->lgu_name)); ?>', <?php echo e($r->cnsp_cases ?? 'null'); ?>, <?php echo e($r->car_cicl_cases ?? 'null'); ?>, <?php echo e($r->car_cicl_male ?? 'null'); ?>, <?php echo e($r->car_cicl_female ?? 'null'); ?>, <?php echo e($r->car_cicl_total ?? 'null'); ?>)">
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M11 4H4a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 013 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                            Edit
                        </button>
                        <form method="POST" action="<?php echo e(route('add.protection.destroy', $r->id)); ?>" style="display:inline;" onsubmit="return confirm('Delete protection record for <?php echo e(addslashes($r->lgu_name)); ?>?')">
