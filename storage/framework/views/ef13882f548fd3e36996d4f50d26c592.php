            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="action-cell" style="text-align:center;">
                        ...
                        <form method="POST" action="<?php echo e(route('add.ip.destroy', $r->id)); ?>" style="display:inline;" onsubmit="return confirm('Delete IP Children record for <?php echo e(addslashes($r->lgu_name)); ?>?')">
