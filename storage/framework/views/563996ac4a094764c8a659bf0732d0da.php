<?php $__env->startSection('title', 'Children with Disability'); ?>
<?php $__env->startSection('page-title', 'Children with Disability'); ?>
...
<div style="display:flex; gap:12px; flex-wrap:wrap; margin-bottom:20px; align-items:center;">
    ...
    <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
        <a href="<?php echo e(route('exports.download', ['dataset' => 'disability', 'format' => 'pdf'])); ?>" class="btn btn-outline btn-sm">PDF</a>
        <a href="<?php echo e(route('exports.download', ['dataset' => 'disability', 'format' => 'excel'])); ?>" class="btn btn-outline btn-sm">Excel</a>
    </div>
</div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="action-cell" style="text-align:center;">
                        ...
                        <form method="POST" action="<?php echo e(route('add.disability.destroy', $r->id)); ?>" style="display:inline;" onsubmit="return confirm('Delete disability record for <?php echo e(addslashes($r->lgu_name)); ?>?')">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\Desktop\cswdo\resources\views/records/disability.blade.php ENDPATH**/ ?>