...
<head>
    ...
    <title>Login – CSWDO Surigao del Norte</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .login-shell {
            ...
            background: url('<?php echo e(asset("bg.jpg")); ?>') center/cover no-repeat;
            padding: 24px;
            position: relative;
            overflow: hidden;
        }
...
<div class="login-shell">
    <div class="login-card">
        ...
        <div class="card-header">
            <div class="logo-wrap">
                <img src="<?php echo e(asset('logo-hri.png')); ?>" alt="CSWDO Logo">
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input
                            ...
                            type="text"
                            name="username"
                            class="form-control <?php echo e($errors->has('username') ? 'has-error' : ''); ?>"
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input
                            ...
                            type="password"
                            name="password"
                            class="form-control <?php echo e($errors->has('password') ? 'has-error' : ''); ?>"
...
<?php /**PATH C:\Users\Admin\Desktop\cswdo\resources\views/auth/login.blade.php ENDPATH**/ ?>