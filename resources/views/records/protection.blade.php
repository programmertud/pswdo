...
@section('page-title', 'Protection Records')
@section('page-sub', 'CNSP, CAR & CICL Cases by LGU — ' . date("Y"))
...
<div style="display:flex; gap:12px; flex-wrap:wrap; margin-bottom:20px; align-items:center;">
    <div class="stat-card red" style="flex:1; min-width:160px;">
        ...
        <span class="stat-value">{{ number_format($totals['cnsp_cases']) }}</span>
    ...
    <div class="stat-card purple" style="flex:1; min-width:160px;">
        ...
        <span class="stat-value">{{ number_format($totals['car_cicl_cases']) }}</span>
    </div>
        ...
        <table class="data-table theme-protection">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="action-cell" style="text-align:center;">
                        ...
                        <form method="POST" action="{{ route('add.protection.destroy', $r->id) }}" style="display:inline;" onsubmit="return confirm('Delete protection record for {{ addslashes($r->lgu_name) }}?')">
                            @csrf @method('DELETE')
            ...
            <tfoot>
                <tr class="total-row">
                    ...
                    <td class="num">{{ number_format($totals['cnsp_cases']) }}</td>
                    <td class="num">{{ number_format($totals['car_cicl_cases']) }}</td>
