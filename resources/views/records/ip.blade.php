...
<div style="display:flex; gap:12px; flex-wrap:wrap; margin-bottom:20px; align-items:center;">
    ...
    <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
        <a href="{{ route('exports.download', ['dataset' => 'ip', 'format' => 'pdf']) }}" target="_blank" class="btn btn-outline btn-sm">PDF</a>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="num">{!! $r->total !== null ? '<strong>'.number_format($r->total).'</strong>' : '<span class="pill pill-amber">N/A</span>' !!}</td>
